import{p as e}from"./math.scalar.functions-PeE1O4gN.js";import{t}from"./shaderStore-1xgJNigV.js";var n=e({lodCubePixelShader:()=>a}),r=`lodCubePixelShader`,i=`precision highp float;const float GammaEncodePowerApprox=1.0/2.2;varying vec2 vUV;uniform samplerCube textureSampler;uniform float lod;uniform int gamma;void main(void)
{vec2 uv=vUV*2.0-1.0;
#ifdef POSITIVEX
